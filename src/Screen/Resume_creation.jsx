              ...
              <div className="row">
                <div className="col-lg-12 col-md-12 col-12">
                  <div className="row">
                    ...
                    <div className="col-lg-4 col-md-12 col-12 mt-2">
                      <div className="form-group">
                        ...
                        <input type="number" className="form-control " id="exampleInputPassword1" placeholder="Enter here" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-12 col-md-12 col-12 mt-2">
                      <div className="form-group">
                        ...
                        <textarea type="text" className="form-control " id="exampleInputPassword1" placeholder="Enter here" />
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="col-lg-12 col-md-12 col-12 mt-2">
                      <div className="form-group">
                        ...
                        <div>
                          ...
                          <input type="search skills here" className="form-control " id="exampleInputPassword1" placeholder="search" />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-12 col-md-12 col-12 mt-4 ">
                    <buttton type="submit" className="btn  submit_resumeCreation">
                      {" "}
