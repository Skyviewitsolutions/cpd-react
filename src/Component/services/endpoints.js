...
export const endpoints = {
  ...
  coaches: {
    ...
    allCoachesList:
      BASE_URL + "/coaches/coaching/get-list" + "?skip_user_id=" + userId,
    ...
    cancellCoaching:
      BASE_URL + "/coaches/coaching/respond-to-enrollment?booking_id=",
    confirmCoaching:
      BASE_URL + "/coaches/coaching/respond-to-enrollment?booking_id=",
    ...
    getCoachingDetailsById:
      BASE_URL + "/coaches/coaching/get-list?coaching_id=",
  },

  workshop: {
    createWorkshop: BASE_URL + "/coaches/workshop/create",
    allWorkshop:
      BASE_URL + "/coaches/workshop/get-list" + "?skip_user_id=" + userId,
    ...
    cancelWorkshop:
      BASE_URL + "/coaches/workshop/respond-to-enrollment?booking_id=",
    confirmWorkshop:
      BASE_URL + "/coaches/workshop/respond-to-enrollment?booking_id=",
    ...
    getWorkshopDetailsById:
      BASE_URL + "/coaches/workshop/get-list?workshop_id=",
