...
<div className="certification_index">
    ...
    <div className="design_details">
      ...
      <h4>Associate Director-Marketing, Star Sports Hong Kong Disneyland</h4>
    ...
    <div className="design_details">
      ...
      <div className="design_name">
      <h4><a href="">Associate Director-Investigations and Due to Diligence</a></h4>
      <span style={{fontSize:"12px",fontWeight:"400"}}>Netrika, Consulting and investigtaion</span>
            <h6>Mumbai, Maharashtra</h6>
            <h6>via Fidanto</h6>           
            <div className='days_box'>
            <img src={days_timing} alt=""></img>
