            ...
            <div className="row">
              ...
              <div className="row mt-4">
                ...
                <div className="col-12 col-md-12 col-lg-5">
                  <button className="cef_tags_button"> communication</button>
                </div>
                <div className="col-12 col-md-12 col-lg-5">
              ...
              <div className="row mt-4">
                ...
                <div className="row">
                  <div className="form-check col-12 col-md-12  col-lg-6">
            ...
            <div className="col-12 col-md-12 col-lg-12">
              <div className="row">
                <div className="col-12 col-md-12 col-lg-6">
                  <div className="event_drop-zone">
                    <div className="studentEvent_files">
                      <GrUpload className="upload_icon_EventForm" />
                      <h6>Upload Session Photo</h6>
                      <br />
                      <span className="event_drop-zone__prompt">Drag and drop to Browser to choose files</span>
                      <input type="file" name="myFile" className="event_drop-zone__input" />
                    </div>
                  </div>
                </div>
                <div className="col-12 col-md-12 col-lg-6">
