  ...
  return (
    <>
     ...
     <div className="chats_header">
        <h5>Chats <span id="online">(online)</span></h5>
        <div className='hide'>
        <h6>Hide chats</h6>
        <img src={side_threepoints} alt="" className='side_threepoints'></img>
        </div>
...
<img src={search_icon} alt=""/>
    <input type="search" id="search_chats" placeholder='Search By Group Title' className='form-control'></input>
</div>
