...
const Student_cv = () => {
  ...
  const addCollege = () => {
    if (sltdSchool == "" || sltdStartYear == "" || sltdEndYear == "" || sltdProgram == "" || sltdField == "") {
      ...
      <div className="container ">
        ...
        <div className="studentCvCntrl">
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6 col-12 ">
                <div className="form-group">
                  ...
                  <PhoneInput country="hk" value={contact} ref={contRef} onChange={(phone) => setContact(phone)} />
                </div>
              </div>
              ...
              <div className="col-12 col-md-6 col-lg-4 ">
                <div className="form-group">
                  ...
                  <select className="form-select  " aria-label="select example" value={nationality} ref={nationalRef} onChange={(e) => setNationality(e.target.value)}>
              ...
              <div className="col-12 col-md-6 col-lg-4 ">
                <div className="form-group">
                  ...
                  <select className="form-select " aria-label="Default select example" value={gender} ref={genderRef} onChange={(e) => setGender(e.target.value)}>
                ...
                <div className="form-group">
                  {uploadImg ? (
                    <>
                      ...
                      <h5 className="form-control" htmlFor="takePhoto">
                        {uploadImg.name}
                      </h5>
                      <input
                        type="file"
                ...
                <>
                  <div className="studentcv_experiencelogoBox" key={index}>
                    ...
                    <div className="studentCV_rightIcon">
                      <FiEdit style={{ color: "gray", cursor: "pointer" }} onClick={() => handleCollegeEdit(itm, index)} />
                      <AiFillMinusCircle
                        onClick={() => {
                          removeCollge(index);
                        }}
              ...
              <div className="row">
                ...
                <div className="col-lg-3 col-md-6 col-12">
                  <div className="form-group">
                    ...
                    <select
                      className="form-select start-year "
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        if (val < sltdStartYear) {
                          showToast("End year cannot be less then start year", "warning");
                        } else {
                ...
                <div className="col-lg-4 col-md-6 col-12 ">
                  {updateCollege === true ? (
                    <button className="addExperiencebutton" onClick={updateSelectedCollege}>
                      Update College
                    </button>
                  ) : (
                    <button className="addExperiencebutton" onClick={addCollege}>
                      Add College
                    </button>
                  )}
                </div>

                <div className="col-lg-4 col-md-12 col-12  removeDiv" style={{ display: "flex", alignItems: "center" }}></div>
              </div>
            </div>
            ...
            <div className="row ">
              <div className="col-12 col-md-12 col-lg-5 ">
                ...
                <div className="form-group ">
                  ...
                  <input type="text" className="form-control " placeholder="choose Domain" value={xtraDomain} onChange={(e) => setXtraDomain(e.target.value)} />
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-lg-4 col-md-6 col-12  ">
                <div className="form-group">
                  ...
                  <input type="text" className="form-control " placeholder="Enter here" value={recommendation} onChange={(e) => setRecommendation(e.target.value)} />
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12  ">
                <div className="form-group">
                  <label for="exampleInputPassword1">Mentor Name</label>
                  <input type="text" className="form-control " placeholder="Enter here" value={mentorName} onChange={(e) => setMentorName(e.target.value)} />
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12  ">
                {/* <div className="form-group">
                ...
                <div className="form-group">
                  <label for="exampleInputPassword1">Coach Name</label>
                  <input type="text" className="form-control " placeholder="Enter here" value={coachName} onChange={(e) => setCoachName(e.target.value)} />
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12  ">
                <div className="form-group">
                  <label for="exampleInputPassword1">Recommendation Email</label>
                  <input type="email" className="form-control " placeholder="Enter here" value={recommEmail} onChange={(e) => setRecommEmail(e.target.value)} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="formoutline_studentcv">
            ...
            <div className="row">
              <div className="col-lg-4 col-md-6 col-12 ">
                <div className="form-group student_cv_search ">
                  <label for="exampleInputPassword1">I want</label>

                  <input type="text" className="form-control " placeholder="Enter here" value={targetGoal} onChange={(e) => setTargetGoal(e.target.value)} />
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12">
                <div className="form-group student_cv_search">
                  ...
                  <input type="text" className="form-control " placeholder="Enter here" value={targetDomain} onChange={(e) => setTargetDomain(e.target.value)} />
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-lg-4 col-md-6 col-12">
                <div className="form-group student_cv_search">
                  ...
                  <input type="text" className="form-control " placeholder="Enter here" value={targetIndustry} onChange={(e) => setTargetIndustry(e.target.value)} />
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12">
                <div className="form-group student_cv_search">
                  ...
                  <input type="text" className="form-control " placeholder="Enter here" value={targetLocation} onChange={(e) => setTargetLocation(e.target.value)} />
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12">
                <div className="form-group  student_cv_search">
                  ...
                  <input type="number" className="form-control " placeholder="Enter here" min="1" value={targetYear} onChange={(e) => setTargetYear(e.target.value)} />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="studentCvBtn">
          <div className="col-lg-3 col-md-6 col-12 text-center">
            <button type="submit" className="submit_resumeCreationButton" onClick={update === true ? updateProfile : submit}>
              {loading ? <Spinner animation="border" variant="light" style={{ width: "20px", height: "20px" }} /> : update ? "Update" : "Submit"}
            </button>
            <Spinner />
          </div>
          <div className="col-lg-3 col-md-6 col-12  text-center">
            <button type="submit" className=" submit_resumeCreationButton" onClick={() => handlePreviewResume()}>
              {" "}
              Preview Resume
            </button>
          </div>
