...
const AddEvent_Modal = (props) => {
  ...
  const { onHide, topics, displayName, description, tags, addCommunity, imgFiles, setTopics, setDisplayName, setDescriptions, setTags, loading, setImgFiles } = props;
  ...
  return (
    <>
      <Modal className="mb-3  ps-3 pe-3" {...props} size="lg" aria-labelledby="contained-modal-title-vcenter" centered>
        <div className="container">
          <Modal.Header className="modal_header" closeButton>
            <Modal.Title id="contained-modal-title-vcenter">{props.update ? "Update Community" : "Create Community"}</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Form>
              <div className="row">
              ...
              <div className="row">
                <div className="col-12 col-md-12 col-lg-12 mt-2">
                  <label for="exampleFormControlTextarea1">Community Description</label>
                  <textarea
                    className="form-control modal_shadow"
              ...
              <div className="row mt-2">
                <div className="col-12 col-md-12 col-lg-12 ">
                  ...
                  <h6 style={{ color: "red", fontSize: "12px", marginTop: 2 }}>Note : Press enter to add multiple tags</h6>
                  {/* <input
                    type="text"
                    className="form-control modal_shadow"
                    id="exampleInputEmail1"
              ...
              <div className="row">
                <div className="col-12 col-md-12 col-lg-12 text-center mt-2">
                  <Button className="upload_modal">
                    <input type="file" id="uploadFile" onChange={(e) => handleImageInput(e)} style={{ display: "none" }} />
                ...
                <div className="col-12 col-md-12 col-lg-12 text-center mt-4" id="file_upload_text">
                  <span>{imgFiles?.name}</span>
                  <h6 style={{ color: "red", fontSize: "13px" }}>*File Format Should be The Pdf, PPt Xlss, TXT</h6>
                </div>
                <div className="col-12 col-md-12 col-lg-12 text-center mt-4 modal_uploaded_file"></div>
              </div>
            </Form>
          </Modal.Body>
