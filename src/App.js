    ...
    <>
      <Router>
        <Routes>
          ...
          <Route exact path="/create_Event_form" element={<PrivateRoute element={<Create_EventForm />} />} />
          <Route exact path="/create-community" element={<PrivateRoute element={<CreateCommunity />} />} />
          <Route exact path="/availableResource" element={<PublicRoute element={<AvailableResource />} />} />
          <Route exact path="/coaches-form" element={<PrivateRoute element={<CoachesForm />} />} />
          <Route exact path="/sidebar_community" element={<AddCommunitySidebar />} />
          <Route exact path="/forgot_password_details" element={<PublicRoute element={<ForgotPasswordDetails />} />} />
          <Route exact path="/inviteMember" element={<CreateEvent_student />} />
          <Route exact path="/community-finance" element={<PublicRoute element={<Workshop />} />}></Route>
          <Route exact path="/community-details/:communityId" element={<PublicRoute element={<CommunityDetails />} />}></Route>
          <Route exact path="/community_RetailSelected" element={<PublicRoute element={<Community_RetailSelected />} />}></Route>
          <Route exact path="/community_RetailLocation" element={<PublicRoute element={<Community_RetailLocation />} />}></Route>
          ...
          <Route exact path="/coach-Details/:coachId" element={<PublicRoute element={<CoachesDetails />} />} />
          ...
          <Route exact path="/communityHeader" element={<PublicRoute element={<CommunityNewSidebar />} />} />
          <Route exact path="/workshopDetails/:workshopId" element={<PublicRoute element={<WorkshopDetails />} />} />
          <Route exact path="/workshopEdit/:workshopId" element={<PrivateRoute element={<WorkshopEdit />} />} />
          <Route exact path="/coachingDetails/:coachingId" element={<PublicRoute element={<CoachesDetails />} />} />
          <Route exact path="/coachingEdit/:coachingId" element={<PrivateRoute element={<CoachingEdit />} />} />
          <Route exact path="/event-full-details/:eventId" element={<PublicRoute element={<EventFullDetails />} />} />
